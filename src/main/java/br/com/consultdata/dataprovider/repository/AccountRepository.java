...
public interface AccountRepository extends JpaRepository<DataEntity, String> {
    ...
    @Query(value = "select bundle.bank as bank,\n" +
            ...
            , nativeQuery = true)
    List<ProjectionAccountServiceBundle> findTopFiveBestPersonalAccountService(String type);
    ...
    @Query(value = "select bundle.bank as bank,\n" +
            ...
            "FETCH FIRST 5 ROWS ONLY"
            , nativeQuery = true)
    List<ProjectionAccountServiceBundle> findBestTopFiveBusinessAccountService(String type);
