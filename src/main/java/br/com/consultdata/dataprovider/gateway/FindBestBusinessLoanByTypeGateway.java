...
import br.com.consultdata.core.usecase.FindBestBusinessLoanByTypeBoundary;
...
public class FindBestBusinessLoanByTypeGateway implements FindBestBusinessLoanByTypeBoundary {

    private final LoansRepository repository;

    @Override
    public List<BestLoan> execute(final String type) {
        List<ProjectionBestLoan> result = repository.findTopFiveBusinessLoansByType(type);
